...
const char* serverAddress = "http://192.168.1.150"; // ip address 

void setup()
{
  Serial.begin(115200);
  Serial.println("RCA IoT Weather Station");
      ...
      for (i = 0; i < 10; i++)
       {
        ...
        delay(100); // Duration for which the buzzer is ON
        digitalWrite(BUZZER, LOW);
        delay(100); // Duration for which the buzzer is OFF
      }
